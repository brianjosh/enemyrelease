...
#Part 2: Damage analysis                 --- Line 62
#Part 3: Phylogenetic analysis           --- Line 163
#Part 4: Traits                          --- Line 323
#Part 5: Survival analysis               --- Line 418
#Part 6: Effect sizes and naturalisation --- Line 859
#Part 7: Main figures                    --- Line 926
#Part 8: Supplementary figures           --- Line 1134
#A joke to finish                        --- Line 1355
...
#Figure 6a
fig6a <- ggplot(regions2, aes(x=logef_I, y=logregions)) +
...
#Figure 6b
fig6b <- ggplot(regions2, aes(x=logef_IF, y=logregions)) +
